...
*See also: [Secrets, Keys, and Data Protection](98-secrets-keys-data-protection.md) for the HSM/TPM/TEE custody ladder for the private keys these certificates depend on.*
