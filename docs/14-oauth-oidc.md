...
Adopt the hardening RFCs explicitly: **RFC 9700** (OAuth 2.0 Security BCP), **RFC 7636** (PKCE), **RFC 9207** (`iss` in the authorization response, to defeat IdP mix-up), **RFC 8707** (resource indicators, to bind tokens to a specific RS audience), and OpenID Connect Core for `id_token` handling.
